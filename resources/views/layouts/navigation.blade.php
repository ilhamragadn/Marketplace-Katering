        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                @if (Auth::user()->role === 'Merchant')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('merchant-product.index')" :active="request()->routeIs('merchant-product.index')">
                            {{ __('Menu') }}
                        </x-nav-link>
                    </div>
                @else
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('customer-product.index')" :active="request()->routeIs('customer-product.index')">
                            {{ __('Menu') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
