                    ...
                    <div class="grid grid-cols-5 gap-2 mx-6">
                        @forelse ($dataProduct as $product)
                            <div
                                ...
                                <img class="rounded-t-lg h-56" src="{{ asset($product->prod_image) }}" alt="prod-img">
                                <div class="mx-2 my-1">
                                ...
                                <a href="{{ route('customer-order.create', $product->id) }}"
                                    class="block w-full mt-2 py-2 bg-green-500 text-gray-100 rounded-b-lg text-center font-bold">Pesan</a>
                            </div>
